...
| `BASE_ANIM_CHANCE` | `'0.32'`, `'0.85'` | `src/cozmo_companion/core/companion_legacy.py:2319`<br>`src/cozmo_companion/core/vida.py:375` |
...
| `BASE_HEAD_FRAC` | `'0.62'` | `src/cozmo_companion/core/motor_cozmo.py:3823` |
| `BASE_HEAD_MOVE_S` | `'22'` | `src/cozmo_companion/core/alive.py:73` |
| `BASE_HEAD_RESET` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:3840` |
| `BASE_HEAD_SPEED` | `'6.0'`, `'8.0'` | `src/cozmo_companion/core/alive.py:84`<br>`src/cozmo_companion/core/motor_cozmo.py:3847` |
| `BASE_HEAD_TOL_RAD` | `'0.09'` | `src/cozmo_companion/core/motor_cozmo.py:3830` |
...
| `BASE_TOGGLE_DEBOUNCE_S` | `'3'`, `'3.0'` | `src/cozmo_companion/core/charger.py:495`<br>`src/cozmo_companion/core/companion.py:664`<br>`src/cozmo_companion/core/companion_legacy.py:1966` |
...
| `BASE_VOZ_SOMENTE_WAKE` | `'1'` | `src/cozmo_companion/core/companion_legacy.py:1480`<br>`src/cozmo_companion/core/companion_voz.py:746` |
...
| `BOTAO_FILA_DRAIN_S` | `'10'` | `src/cozmo_companion/core/companion.py:648`<br>`src/cozmo_companion/core/companion_legacy.py:1924` |
| `BOTAO_OLED_S` | `'2.5'` | `src/cozmo_companion/core/companion.py:602`<br>`src/cozmo_companion/core/companion_legacy.py:1890` |
| `BOTAO_QUIET_S` | `'4'`, `'5'` | `src/cozmo_companion/core/companion.py:603`<br>`src/cozmo_companion/core/companion_legacy.py:1889`<br>`src/cozmo_companion/core/companion_legacy.py:1886` |
| `BOTAO_TRANSICAO_S` | `'8'`, `os.environ.get('BOTAO_QUIET_S', '5')` | `src/cozmo_companion/core/companion.py:609`<br>`src/cozmo_companion/core/companion_legacy.py:1884` |
...
| `CARINHO_BURST_GAP_S` | `'20'` | `src/cozmo_companion/core/companion.py:579`<br>`src/cozmo_companion/core/companion_legacy.py:1102` |
| `CARINHO_COOLDOWN_S` | `'10'`, `'16'`, `'16' if self._na_base_efetivo() else '8'` | `src/cozmo_companion/core/companion.py:576`<br>`src/cozmo_companion/core/companion_legacy.py:1097`<br>`src/cozmo_companion/core/head_touch.py:13` |
...
| `CARINHO_LINK_GRACE_S` | `'20'`, `'45'` | `src/cozmo_companion/core/companion.py:308`<br>`src/cozmo_companion/core/companion_legacy.py:428` |
...
| `CHAT_ENABLED` | `'1'` | `src/cozmo_companion/core/companion.py:102`<br>`src/cozmo_companion/core/companion_legacy.py:179` |
| `CLIFF_MIN_RAW` | `'380'` | `src/cozmo_companion/core/mesa.py:32` |
| `CLIFF_RATIO` | `'0.58'` | `src/cozmo_companion/core/mesa.py:33` |
| `COOLDOWN_VOZ_BASE_S` | `'12'`, `'3'` | `src/cozmo_companion/core/companion_legacy.py:1251`<br>`src/cozmo_companion/core/companion_legacy.py:1874`<br>`src/cozmo_companion/core/companion_voz.py:534` |
| `COZMO01_AQUECIMENTO_S` | `'20'` | `src/cozmo_companion/core/companion.py:1197` |
| `COZMO01_AUTO_COOLDOWN_S` | `'18'` | `src/cozmo_companion/core/motor_cozmo.py:4291` |
| `COZMO01_CLIP_ACK_S` | `'0.45'` | `src/cozmo_companion/core/motor_cozmo.py:4251` |
| `COZMO01_DISCONNECT_PAUSE_S` | `os.environ.get('COZMO_DISCONNECT_PAUSE_S', '5')` | `src/cozmo_companion/core/companion.py:1155` |
| `COZMO01_DRAIN_S` | `'4'` | `src/cozmo_companion/core/motor_cozmo.py:4162` |
...
| `COZMO01_PING_GAP_S` | `'0.12'` | `src/cozmo_companion/core/motor_cozmo.py:4198` |
| `COZMO01_POST_RESET_MIN_S` | `'60'` | `src/cozmo_companion/core/companion.py:1111` |
...
| `COZMO01_RX_DEAD_MAX_S` | `'12'` | `src/cozmo_companion/core/cozmo01_recovery.py:164` |
| `COZMO01_RX_DEAD_ROUTE_S` | `'20'`, `'90'` | `src/cozmo_companion/core/companion.py:1332`<br>`src/cozmo_companion/core/cozmo01_recovery.py:168`<br>`src/cozmo_companion/core/motor_cozmo.py:4190` |
| `COZMO01_RX_DEAD_S` | `'8'` | `src/cozmo_companion/core/conexao.py:657`<br>`src/cozmo_companion/core/motor_cozmo.py:4188` |
| `COZMO01_SLEEP_TIMEOUT_S` | `'120'` | `src/cozmo_companion/core/motor_cozmo.py:4192` |
| `COZMO01_STALL_MAX_S` | `'10'` | `src/cozmo_companion/core/cozmo01_recovery.py:128` |
| `COZMO01_WATCHDOG_COOLDOWN_S` | `'20'` | `src/cozmo_companion/core/companion.py:1334` |
| `COZMO01_WATCHDOG_S` | `'30'` | `src/cozmo_companion/core/companion.py:1328` |
| `COZMO_ALLOW_MULTI` | `'0'` | `src/cozmo_companion/core/singleton.py:18` |
| `COZMO_ANIM_BASE_HOLD_S` | `'2.5'`, `'4'` | `src/cozmo_companion/core/companion.py:521`<br>`src/cozmo_companion/core/companion_legacy.py:796`<br>`src/cozmo_companion/core/companion_legacy.py:3060`<br>`src/cozmo_companion/core/companion_legacy.py:3046`<br>`src/cozmo_companion/core/motor_cozmo.py:508` |
| `COZMO_ANIM_CARGA_S` | `'180'` | `src/cozmo_companion/core/charger.py:795` |
| `COZMO_ANIM_SOURCE_FPS` | `'30'` | `src/cozmo_companion/core/motor_cozmo.py:1610` |
| `COZMO_ANIM_TRAVADA_S` | `'6'` | `src/cozmo_companion/core/motor_cozmo.py:778` |
| `COZMO_BASE_CLIP_DRAIN_S` | `'4'` | `src/cozmo_companion/core/motor_cozmo.py:1676` |
| `COZMO_BASE_CLIP_LOOP_S` | `'18'` | `src/cozmo_companion/core/motor_cozmo.py:1734` |
| `COZMO_BASE_CLIP_MAX_S` | `'12'` | `src/cozmo_companion/core/motor_cozmo.py:1441` |
| `COZMO_BASE_CLIP_REPLAY_MIN_S` | `'14'` | `src/cozmo_companion/core/motor_cozmo.py:2379` |
| `COZMO_BASE_DESPERTAR_S` | `'35'` | `src/cozmo_companion/core/companion.py:1441` |
| `COZMO_BASE_FACE_HZ` | `'0.25'` | `src/cozmo_companion/core/motor_cozmo.py:3975` |
| `COZMO_BASE_FULL_KEEPER_HZ` | `'4'`, `'7'` | `src/cozmo_companion/core/motor_cozmo.py:1597`<br>`src/cozmo_companion/core/motor_cozmo.py:3274` |
...
| `COZMO_BASE_KEEPER_PROCEDURAL` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:3542` |
| `COZMO_BASE_KEEPER_VIVO` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:3158`<br>`src/cozmo_companion/core/motor_cozmo.py:4776`<br>`src/cozmo_companion/core/motor_cozmo.py:1281`<br>`src/cozmo_companion/core/motor_cozmo.py:3244`<br>`src/cozmo_companion/core/motor_cozmo.py:3934`<br>`src/cozmo_companion/core/motor_cozmo.py:4547`<br>`src/cozmo_companion/core/motor_cozmo.py:3658` |
| `COZMO_BASE_OLED_ANIMATED` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:1499` |
| `COZMO_BASE_OLED_ANIM_LOOP` | `'auto'` | `src/cozmo_companion/core/motor_cozmo.py:1457` |
| `COZMO_BASE_OLED_CHARGER` | `'1'` | `src/cozmo_companion/core/conexao.py:944`<br>`src/cozmo_companion/core/fila_cozmo.py:352`<br>`src/cozmo_companion/core/motor_cozmo.py:1349`<br>`src/cozmo_companion/core/motor_cozmo.py:2167` |
...
| `COZMO_BASE_OLED_KEEPALIVE` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:2564`<br>`src/cozmo_companion/core/motor_cozmo.py:1463` |
| `COZMO_BASE_OLED_KEEPALIVE_HZ` | `'5'` | `src/cozmo_companion/core/motor_cozmo.py:2476` |
| `COZMO_BASE_OLED_LOOP_BACKOFF_S` | `'240'` | `src/cozmo_companion/core/motor_cozmo.py:1510` |
| `COZMO_BASE_OLED_MANTER_EM_STALL` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:2495` |
| `COZMO_BASE_OLED_MIN` | `'1'` | `src/cozmo_companion/core/conexao.py:947`<br>`src/cozmo_companion/core/motor_cozmo.py:3789`<br>`src/cozmo_companion/core/motor_cozmo.py:3731` |
| `COZMO_BASE_OLED_MIN_BYTES` | `'56'` | `src/cozmo_companion/core/motor_cozmo.py:2271` |
| `COZMO_BASE_OLED_MIN_FRAMES` | `'8'` | `src/cozmo_companion/core/anim_base_patch.py:155`<br>`src/cozmo_companion/core/motor_cozmo.py:1129`<br>`src/cozmo_companion/core/motor_cozmo.py:2270`<br>`src/cozmo_companion/core/motor_cozmo.py:2371` |
| `COZMO_BASE_OLED_MODE` | `'proc'` | `src/cozmo_companion/core/motor_cozmo.py:1465`<br>`src/cozmo_companion/core/motor_cozmo.py:3774` |
| `COZMO_BASE_OLED_STALL_HZ` | `'0.25'` | `src/cozmo_companion/core/motor_cozmo.py:2509` |
...
| `COZMO_BASE_PROC_HZ` | `'2'`, `'3'` | `src/cozmo_companion/core/motor_cozmo.py:3360`<br>`src/cozmo_companion/core/motor_cozmo.py:3638` |
| `COZMO_BASE_PULSE_PROC` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:3810` |
...
| `COZMO_BASE_VARIAR_ANTI_REPEAT` | `'3'` | `src/cozmo_companion/core/motor_cozmo.py:1093`<br>`src/cozmo_companion/core/motor_cozmo.py:1254`<br>`src/cozmo_companion/core/motor_cozmo.py:1565` |
...
| `COZMO_BASE_VARIAR_JITTER_S` | `'8'` | `src/cozmo_companion/core/motor_cozmo.py:1645` |
| `COZMO_BASE_VARIAR_LUZ` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:1185` |
| `COZMO_BASE_VARIAR_MAX_S` | `'55'` | `src/cozmo_companion/core/motor_cozmo.py:1646` |
| `COZMO_BASE_VARIAR_S` | `'32'`, `'38'` | `src/cozmo_companion/core/motor_cozmo.py:1644`<br>`src/cozmo_companion/core/motor_cozmo.py:1224` |
| `COZMO_BASE_WAKE_ANIM` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:4122` |
| `COZMO_BOOT_ACORDADO` | `'1'` | `src/cozmo_companion/core/companion.py:1801`<br>`src/cozmo_companion/core/companion.py:1835` |
| `COZMO_BOOT_FRESH_SESSION` | `'0'` | `src/cozmo_companion/core/companion.py:1253`<br>`src/cozmo_companion/core/companion.py:1266`<br>`src/cozmo_companion/core/companion.py:1831`<br>`src/cozmo_companion/core/companion.py:1239` |
| `COZMO_BOOT_FRESH_WAIT_S` | `'6'` | `src/cozmo_companion/core/companion.py:1238` |
| `COZMO_BOOT_OI` | `'0'` | `src/cozmo_companion/core/companion_legacy.py:3173` |
| `COZMO_BOOT_QUIET_S` | `'4'`, `os.environ.get('COZMO_POST_RECONNECT_S', '10')` | `src/cozmo_companion/core/companion.py:1895`<br>`src/cozmo_companion/core/companion_legacy.py:3162` |
...
| `COZMO_CHARGER_AWAKE_IDLE` | `'IdleOnCharger'`, `None` | `src/cozmo_companion/core/motor_cozmo.py:1050`<br>`src/cozmo_companion/core/motor_cozmo.py:3048`<br>`src/cozmo_companion/core/motor_cozmo.py:1207`<br>`src/cozmo_companion/core/motor_cozmo.py:1186`<br>`src/cozmo_companion/core/motor_cozmo.py:1563`<br>`src/cozmo_companion/core/motor_cozmo.py:3258`<br>`src/cozmo_companion/core/motor_cozmo.py:4318` |
| `COZMO_CHARGER_CLIP_S` | `'14'` | `src/cozmo_companion/core/motor_cozmo.py:1434` |
| `COZMO_CHARGER_LOOP_PAUSE_S` | `'0.12'` | `src/cozmo_companion/core/motor_cozmo.py:1938` |
| `COZMO_CHARGER_OLED_HZ` | `'1.5'`, `'2.5'`, `'4'` | `src/cozmo_companion/core/motor_cozmo.py:2896`<br>`src/cozmo_companion/core/motor_cozmo.py:1599`<br>`src/cozmo_companion/core/motor_cozmo.py:3340` |
| `COZMO_CHARGER_OLED_KEEPER` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:2111` |
| `COZMO_CHARGER_PLAY_STREAM` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:1462`<br>`src/cozmo_companion/core/motor_cozmo.py:2142`<br>`src/cozmo_companion/core/motor_cozmo.py:2156` |
| `COZMO_CHARGER_REPLAY_S` | `'18'` | `src/cozmo_companion/core/motor_cozmo.py:2898` |
| `COZMO_CHARGER_STREAM_NA_CHEIA` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:2144` |
| `COZMO_CHARGE_IDLE_S` | `'18'` | `src/cozmo_companion/core/charger.py:777`<br>`src/cozmo_companion/core/motor_cozmo.py:4664` |
...
| `COZMO_DISCONNECT_PAUSE_S` | `'12'`, `'5'` | `src/cozmo_companion/core/companion.py:1160`<br>`src/cozmo_companion/core/companion.py:1157`<br>`src/cozmo_companion/core/companion_legacy.py:2634`<br>`src/cozmo_companion/core/conexao.py:1015` |
...
| `COZMO_FACE_BASE` | `'0'`, `'1'` | `src/cozmo_companion/core/companion.py:1618`<br>`src/cozmo_companion/core/companion_legacy.py:509`<br>`src/cozmo_companion/core/companion_legacy.py:3206`<br>`src/cozmo_companion/core/face_watch.py:83`<br>`src/cozmo_companion/core/face_watch.py:133`<br>`src/cozmo_companion/core/face_watch.py:140`<br>`src/cozmo_companion/core/face_watch.py:216`<br>`src/cozmo_companion/core/vida.py:173`<br>`src/cozmo_companion/core/vida.py:759` |
...
| `COZMO_FILA_ATIVA` | `'1'` | `src/cozmo_companion/core/fila_cozmo.py:218`<br>`src/cozmo_companion/core/fila_cozmo.py:682` |
...
| `COZMO_FULL_CHARGE_WAKE` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:3680` |
| `COZMO_FULL_CHARGE_WAKE_S` | `'12'` | `src/cozmo_companion/core/motor_cozmo.py:3686` |
| `COZMO_INPLACE_FAIL_MAX` | `'2'`, `'3'` | `src/cozmo_companion/core/companion.py:1083`<br>`src/cozmo_companion/core/companion_legacy.py:2607`<br>`src/cozmo_companion/core/companion_legacy.py:2712`<br>`src/cozmo_companion/core/companion_legacy.py:1843` |
...
| `COZMO_KEEPALIVE_S` | `'10'`, `'8'` | `src/cozmo_companion/core/companion.py:1297`<br>`src/cozmo_companion/core/companion_legacy.py:2763` |
| `COZMO_KEEPER_DURING_TTS` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:3391` |
...
| `COZMO_NEVER_DISCONNECT` | `'1'` | `src/cozmo_companion/core/companion.py:2027`<br>`src/cozmo_companion/core/companion_legacy.py:3272`<br>`src/cozmo_companion/core/conexao.py:128`<br>`src/cozmo_companion/core/conexao.py:540` |
| `COZMO_NICE` | `'10'` | `src/cozmo_companion/core/companion.py:2021`<br>`src/cozmo_companion/core/companion_legacy.py:3268` |
...
| `COZMO_OFFLINE_BACKOFF_MAX_S` | `'600'` | `src/cozmo_companion/core/companion.py:2031` |
| `COZMO_OFFLINE_BACKOFF_S` | `'120'` | `src/cozmo_companion/core/companion.py:2030` |
| `COZMO_OFFLINE_LOG_S` | `'300'` | `src/cozmo_companion/core/conexao.py:236` |
| `COZMO_OFFLINE_QUIET_S` | `'45'` | `src/cozmo_companion/core/companion.py:1376` |
| `COZMO_OLED_DIRECT` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:4541` |
...
| `COZMO_OLED_KEEPALIVE_S` | `'0.45'` | `src/cozmo_companion/core/motor_cozmo.py:3986` |
...
| `COZMO_OLED_NA_BASE` | `'0'` | `src/cozmo_companion/core/companion.py:426`<br>`src/cozmo_companion/core/fila_cozmo.py:351`<br>`src/cozmo_companion/core/motor_cozmo.py:4532` |
| `COZMO_OLED_PHASE_UPGRADE_S` | `'45'` | `src/cozmo_companion/core/motor_cozmo.py:111` |
| `COZMO_OLED_REFRESH_S` | `'12'`, `'2.5'` | `src/cozmo_companion/core/motor_cozmo.py:3978`<br>`src/cozmo_companion/display/face.py:143` |
| `COZMO_OLED_RESCUE_MIN_BYTES` | `'64'` | `src/cozmo_companion/core/motor_cozmo.py:2178` |
| `COZMO_OLED_RESCUE_RECENT_S` | `'15'` | `src/cozmo_companion/core/motor_cozmo.py:816` |
| `COZMO_OLED_RESCUE_STALL_GRACE_S` | `'8'` | `src/cozmo_companion/core/motor_cozmo.py:820`<br>`src/cozmo_companion/core/motor_cozmo.py:2503` |
...
| `COZMO_PING_INTERVAL_S` | `'0.5'` | `src/cozmo_companion/core/motor_cozmo.py:3857` |
| `COZMO_PING_OOB_S` | `'4.5'` | `src/cozmo_companion/core/companion_legacy.py:3100` |
| `COZMO_PING_PRE_CLIP` | `'2'` | `src/cozmo_companion/core/motor_cozmo.py:2332` |
| `COZMO_PING_TIMEOUT_S` | `'4'` | `src/cozmo_companion/core/conexao.py:137` |
| `COZMO_POST_RECONNECT_S` | `'10'`, `'22'`, `'35'`, `'60'` | `src/cozmo_companion/core/companion.py:258`<br>`src/cozmo_companion/core/companion.py:373`<br>`src/cozmo_companion/core/companion.py:385`<br>`src/cozmo_companion/core/companion.py:1140`<br>`src/cozmo_companion/core/companion_legacy.py:443`<br>`src/cozmo_companion/core/companion_legacy.py:453`<br>`src/cozmo_companion/core/companion_legacy.py:2624`<br>`src/cozmo_companion/core/companion_legacy.py:2663`<br>`src/cozmo_companion/core/companion_legacy.py:3164`<br>`src/cozmo_companion/core/companion_legacy.py:1832`<br>`src/cozmo_companion/core/companion_legacy.py:1847`<br>`src/cozmo_companion/core/limites.py:34` |
...
| `COZMO_PROC_FACE` | `'1'` | `src/cozmo_companion/core/companion.py:304`<br>`src/cozmo_companion/core/companion_legacy.py:3090`<br>`src/cozmo_companion/core/companion_legacy.py:1869`<br>`src/cozmo_companion/core/companion_legacy.py:1931`<br>`src/cozmo_companion/core/conexao.py:952`<br>`src/cozmo_companion/core/motor_cozmo.py:4079`<br>`src/cozmo_companion/core/motor_cozmo.py:4431`<br>`src/cozmo_companion/core/motor_cozmo.py:4524`<br>`src/cozmo_companion/display/face.py:129` |
| `COZMO_PROC_FACE_BASE` | `'0'`, `'1'` | `src/cozmo_companion/core/charger.py:796`<br>`src/cozmo_companion/core/companion.py:303`<br>`src/cozmo_companion/core/companion_legacy.py:2937`<br>`src/cozmo_companion/core/conexao.py:852`<br>`src/cozmo_companion/core/face_watch.py:421`<br>`src/cozmo_companion/core/motor_cozmo.py:2123`<br>`src/cozmo_companion/core/motor_cozmo.py:4038`<br>`src/cozmo_companion/core/motor_cozmo.py:3923`<br>`src/cozmo_companion/core/motor_cozmo.py:4077`<br>`src/cozmo_companion/core/vida.py:229`<br>`src/cozmo_companion/core/vida.py:560` |
...
| `COZMO_RATIO_PREVENT_COOLDOWN_S` | `'25'`, `'45'` | `src/cozmo_companion/core/companion.py:1119`<br>`src/cozmo_companion/core/companion_legacy.py:2795`<br>`src/cozmo_companion/core/sessao_guard.py:20` |
...
| `COZMO_RECONNECT_WAIT_PING_S` | `'25'` | `src/cozmo_companion/core/companion.py:1143`<br>`src/cozmo_companion/core/companion_legacy.py:2626` |
| `COZMO_RENOVAR_BASE_S` | `'20'` | `src/cozmo_companion/core/motor_cozmo.py:2699`<br>`src/cozmo_companion/core/motor_cozmo.py:2944` |
| `COZMO_RENOVAR_FORCAR_MIN_S` | `'8'` | `src/cozmo_companion/core/motor_cozmo.py:2702` |
...
| `COZMO_SLEEP_CLIP_HOLD_S` | `'22'`, `'28'` | `src/cozmo_companion/core/motor_cozmo.py:1641`<br>`src/cozmo_companion/core/motor_cozmo.py:1758` |
| `COZMO_SLEEP_CLIP_JITTER_S` | `'10'` | `src/cozmo_companion/core/motor_cozmo.py:1642` |
...
| `COZMO_SYNC_BASE_RX_OFF_S` | `'3'` | `src/cozmo_companion/core/motor_cozmo.py:4097` |
| `COZMO_SYNC_BASE_S` | `'5'`, `'8'` | `src/cozmo_companion/core/motor_cozmo.py:2804`<br>`src/cozmo_companion/core/motor_cozmo.py:4095` |
...
| `COZMO_TTS_SINAL_QUIET_S` | `'10'`, `'6'`, `'6' if manter_face else '8'`, `'8'` | `src/cozmo_companion/core/companion_legacy.py:345`<br>`src/cozmo_companion/core/companion_legacy.py:1811`<br>`src/cozmo_companion/core/companion_voz.py:306`<br>`src/cozmo_companion/core/companion_voz.py:345`<br>`src/cozmo_companion/core/companion_voz.py:342`<br>`src/cozmo_companion/core/companion_voz.py:448`<br>`src/cozmo_companion/core/fila_cozmo.py:606`<br>`src/cozmo_companion/core/fila_cozmo.py:603` |
...
| `COZMO_UDP_QUIET_S` | `'12'`, `'20'`, `'25'` | `src/cozmo_companion/core/companion.py:394`<br>`src/cozmo_companion/core/companion_legacy.py:479`<br>`src/cozmo_companion/core/limites.py:35` |
...
| `COZMO_VOLUME_FILE` | `'/mnt/G/PROJETOS/cozmo-companion/data/volume.txt'`, `str(data_dir() / 'volume.txt')` | `src/cozmo_companion/core/companion.py:197`<br>`src/cozmo_companion/core/companion_legacy.py:202` |
...
| `COZMO_VOZ_INJECT` | `'0'` | `src/cozmo_companion/core/companion_legacy.py:2522`<br>`src/cozmo_companion/core/companion_voz.py:947` |
...
| `COZMO_WIFI_STALL_S` | `'25'` | `src/cozmo_companion/core/companion.py:1385` |
...
| `LLM_ACOES` | `'1'` | `src/cozmo_companion/core/companion_legacy.py:2117`<br>`src/cozmo_companion/core/companion_legacy.py:1657`<br>`src/cozmo_companion/core/companion_legacy.py:2074`<br>`src/cozmo_companion/core/companion_voz.py:898`<br>`src/cozmo_companion/voice/chat.py:63` |
| `LOOP_SLEEP` | `'0.15'`, `'0.25'` | `src/cozmo_companion/core/companion.py:1904`<br>`src/cozmo_companion/core/perf.py:46` |
...
| `NOTIF_ENABLED` | `'0'` | `src/cozmo_companion/core/companion_legacy.py:2579`<br>`src/cozmo_companion/core/companion_voz.py:989`<br>`src/cozmo_companion/notifications/core/policy.py:171` |
...
| `NOTIF_POST_QUIET_S` | `'6'`, `os.environ.get('NOTIF_UDP_QUIET_S', '8')` | `src/cozmo_companion/core/fila_cozmo.py:653`<br>`src/cozmo_companion/core/fila_cozmo.py:631` |
...
| `NOTIF_SCROLL_PASSO_S` | `'0.85'`, `'1.0'` | `src/cozmo_companion/core/companion_legacy.py:1363`<br>`src/cozmo_companion/core/fila_cozmo.py:373` |
...
| `NOTIF_SOM_S` | `'0.65'` | `src/cozmo_companion/core/companion_voz.py:380`<br>`src/cozmo_companion/core/fila_cozmo.py:543`<br>`src/cozmo_companion/notifications/core/handler.py:164` |
...
| `NOTIF_TTS_QUIET_S` | `os.environ.get('COZMO_TTS_SINAL_QUIET_S', '6')` | `src/cozmo_companion/core/companion_voz.py:340`<br>`src/cozmo_companion/core/fila_cozmo.py:601` |
| `NOTIF_UDP_QUIET_S` | `'10'`, `'8'` | `src/cozmo_companion/core/fila_cozmo.py:633`<br>`src/cozmo_companion/notifications/core/handler.py:207` |
...
| `OLLAMA_MODEL` | `'llama3.2:1b'` | `src/cozmo_companion/core/companion.py:109`<br>`src/cozmo_companion/core/companion_legacy.py:218` |
...
| `OLLAMA_URL` | `'http://127.0.0.1:11434'` | `src/cozmo_companion/core/companion.py:108`<br>`src/cozmo_companion/core/companion_legacy.py:217` |
...
| `PULSE_ANIM_CHANCE` | `'0.35'` | `src/cozmo_companion/core/companion.py:1588` |
| `REACAO_OFICIAL_ENABLED` | `'1'` | `src/cozmo_companion/core/companion_voz.py:577` |
| `SEMPRE_PULSE_S` | `'15'`, `'16'` | `src/cozmo_companion/core/companion.py:1571`<br>`src/cozmo_companion/core/companion_legacy.py:2249` |
| `SEMPRE_VIVO` | `'1'` | `src/cozmo_companion/core/charger.py:871`<br>`src/cozmo_companion/core/companion_legacy.py:486`<br>`src/cozmo_companion/core/companion_legacy.py:2277`<br>`src/cozmo_companion/core/vida.py:462`<br>`src/cozmo_companion/core/vida.py:737`<br>`src/cozmo_companion/core/vida.py:738`<br>`src/cozmo_companion/core/vida.py:739`<br>`src/cozmo_companion/core/vida.py:740` |
...
| `TELA_RESPOSTA_S` | `'6'`, `'8'` | `src/cozmo_companion/core/companion_legacy.py:1177`<br>`src/cozmo_companion/core/companion_legacy.py:1007`<br>`src/cozmo_companion/core/companion_voz.py:503`<br>`src/cozmo_companion/core/companion_voz.py:212` |
...
| `TTS_SINAL_MANTEM_FACE_BASE` | `'1'` | `src/cozmo_companion/core/companion_voz.py:407`<br>`src/cozmo_companion/core/companion_voz.py:292`<br>`src/cozmo_companion/core/fila_cozmo.py:588`<br>`src/cozmo_companion/core/fila_cozmo.py:593` |
...
| `VOSK_MODEL` | `'/mnt/G/PROJETOS/cozmo-companion/data/vosk-model-small-pt-0.3'` | `src/cozmo_companion/core/companion_legacy.py:2554`<br>`src/cozmo_companion/core/companion_voz.py:964` |
...
| `WAKE_NA_BASE_RELAX` | `'1'` | `src/cozmo_companion/core/companion_legacy.py:1147`<br>`src/cozmo_companion/core/companion_legacy.py:1464`<br>`src/cozmo_companion/core/companion_voz.py:479` |
| `WAKE_OBRIGATORIO` | `'0'` | `src/cozmo_companion/voice/intent.py:157` |
| `WAKE_RELAX` | `'1'` | `src/cozmo_companion/core/companion_legacy.py:1502`<br>`src/cozmo_companion/core/companion_voz.py:753` |
