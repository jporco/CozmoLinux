...
| `BASE_HEAD_FRAC` | `'0.62'` | `src/cozmo_companion/core/motor_cozmo.py:4004` |
| `BASE_HEAD_MOVE_S` | `'22'` | `src/cozmo_companion/core/alive.py:73` |
| `BASE_HEAD_RESET` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:4021` |
| `BASE_HEAD_SPEED` | `'6.0'`, `'8.0'` | `src/cozmo_companion/core/alive.py:84`<br>`src/cozmo_companion/core/motor_cozmo.py:4028` |
| `BASE_HEAD_TOL_RAD` | `'0.09'` | `src/cozmo_companion/core/motor_cozmo.py:4011` |
...
| `BASE_TOGGLE_DEBOUNCE_S` | `'3'`, `'3.0'` | `src/cozmo_companion/core/charger.py:495`<br>`src/cozmo_companion/core/companion.py:690` |
...
| `BATTERY_CHARGE_STOP_PCT` | `'90'` | `src/cozmo_companion/core/charger.py:53`<br>`src/cozmo_companion/core/charger.py:170`<br>`src/cozmo_companion/core/motor_cozmo.py:1068`<br>`src/cozmo_companion/core/motor_cozmo.py:1361` |
...
| `BOTAO_FILA_DRAIN_S` | `'10'` | `src/cozmo_companion/core/companion.py:674` |
| `BOTAO_OLED_S` | `'2.5'` | `src/cozmo_companion/core/companion.py:628` |
| `BOTAO_QUIET_S` | `'4'` | `src/cozmo_companion/core/companion.py:629` |
| `BOTAO_TRANSICAO_S` | `'8'` | `src/cozmo_companion/core/companion.py:635` |
...
| `CARINHO_BURST_GAP_S` | `'20'` | `src/cozmo_companion/core/companion.py:605` |
| `CARINHO_COOLDOWN_S` | `'10'`, `'16'` | `src/cozmo_companion/core/companion.py:602`<br>`src/cozmo_companion/core/head_touch.py:13` |
...
| `CARINHO_LINK_GRACE_S` | `'45'` | `src/cozmo_companion/core/companion.py:321` |
...
| `COZMO01_AQUECIMENTO_S` | `'20'` | `src/cozmo_companion/core/companion.py:1266` |
| `COZMO01_AUTO_COOLDOWN_S` | `'18'` | `src/cozmo_companion/core/motor_cozmo.py:4479` |
| `COZMO01_CLIP_ACK_S` | `'0.45'` | `src/cozmo_companion/core/motor_cozmo.py:4439` |
| `COZMO01_DISCONNECT_PAUSE_S` | `os.environ.get('COZMO_DISCONNECT_PAUSE_S', '5')` | `src/cozmo_companion/core/companion.py:1224` |
| `COZMO01_DRAIN_S` | `'4'` | `src/cozmo_companion/core/motor_cozmo.py:4350` |
...
| `COZMO01_EMERG_RESET_FAILS` | `'1'` | `src/cozmo_companion/core/cozmo01_recovery.py:148` |
| `COZMO01_KEEPER_RX_DEAD_MAX_S` | `'8'` | `src/cozmo_companion/core/cozmo01_recovery.py:164` |
| `COZMO01_OLED_RECENT_S` | `'45'` | `src/cozmo_companion/core/motor_cozmo.py:805` |
| `COZMO01_PING_GAP_S` | `'0.12'` | `src/cozmo_companion/core/motor_cozmo.py:4386` |
| `COZMO01_POST_RESET_MIN_S` | `'60'` | `src/cozmo_companion/core/companion.py:1180` |
...
| `COZMO01_RX_DEAD_MAX_S` | `'12'` | `src/cozmo_companion/core/cozmo01_recovery.py:184` |
| `COZMO01_RX_DEAD_ROUTE_S` | `'20'`, `'90'` | `src/cozmo_companion/core/companion.py:1424`<br>`src/cozmo_companion/core/cozmo01_recovery.py:188`<br>`src/cozmo_companion/core/motor_cozmo.py:4378` |
| `COZMO01_RX_DEAD_S` | `'8'` | `src/cozmo_companion/core/conexao.py:693`<br>`src/cozmo_companion/core/motor_cozmo.py:4376` |
| `COZMO01_SLEEP_TIMEOUT_S` | `'120'` | `src/cozmo_companion/core/motor_cozmo.py:4380` |
| `COZMO01_STALL_MAX_S` | `'10'` | `src/cozmo_companion/core/cozmo01_recovery.py:143` |
| `COZMO01_WATCHDOG_COOLDOWN_S` | `'20'` | `src/cozmo_companion/core/companion.py:1426` |
| `COZMO01_WATCHDOG_S` | `'30'` | `src/cozmo_companion/core/companion.py:1420` |
| `COZMO_ALLOW_MULTI` | `'0'` | `src/cozmo_companion/core/singleton.py:18` |
| `COZMO_ANIM_BASE_HOLD_S` | `'2.5'` | `src/cozmo_companion/core/companion.py:547`<br>`src/cozmo_companion/core/motor_cozmo.py:507` |
| `COZMO_ANIM_CARGA_S` | `'180'` | `src/cozmo_companion/core/charger.py:795` |
| `COZMO_ANIM_SOURCE_FPS` | `'30'` | `src/cozmo_companion/core/motor_cozmo.py:1643` |
| `COZMO_ANIM_TRAVADA_S` | `'6'` | `src/cozmo_companion/core/motor_cozmo.py:777` |
| `COZMO_BASE_CLIP_DRAIN_S` | `'4'` | `src/cozmo_companion/core/motor_cozmo.py:1709` |
| `COZMO_BASE_CLIP_LOOP_S` | `'18'` | `src/cozmo_companion/core/motor_cozmo.py:1767` |
| `COZMO_BASE_CLIP_MAX_S` | `'12'` | `src/cozmo_companion/core/motor_cozmo.py:1461` |
| `COZMO_BASE_CLIP_REPLAY_MIN_S` | `'14'` | `src/cozmo_companion/core/motor_cozmo.py:2416` |
| `COZMO_BASE_DESPERTAR_S` | `'35'` | `src/cozmo_companion/core/companion.py:1549` |
| `COZMO_BASE_FACE_HZ` | `'0.25'` | `src/cozmo_companion/core/motor_cozmo.py:4156` |
| `COZMO_BASE_FULL_KEEPER_HZ` | `'4'`, `'7'` | `src/cozmo_companion/core/motor_cozmo.py:1630`<br>`src/cozmo_companion/core/motor_cozmo.py:3397` |
| `COZMO_BASE_HEAD_MAX_DEG` | `'6'` | `src/cozmo_companion/core/anim_base_patch.py:45` |
| `COZMO_BASE_IDLE_PESO` | `'0.35'` | `src/cozmo_companion/core/motor_cozmo.py:1111` |
| `COZMO_BASE_KEEPER_PROCEDURAL` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:3672` |
| `COZMO_BASE_KEEPER_VIVO` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:3271`<br>`src/cozmo_companion/core/motor_cozmo.py:5052`<br>`src/cozmo_companion/core/motor_cozmo.py:1301`<br>`src/cozmo_companion/core/motor_cozmo.py:3367`<br>`src/cozmo_companion/core/motor_cozmo.py:4115`<br>`src/cozmo_companion/core/motor_cozmo.py:3824` |
| `COZMO_BASE_OLED_ANIMATED` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:1524` |
| `COZMO_BASE_OLED_ANIM_LOOP` | `'auto'` | `src/cozmo_companion/core/motor_cozmo.py:1471` |
| `COZMO_BASE_OLED_CHARGER` | `'1'` | `src/cozmo_companion/core/conexao.py:994`<br>`src/cozmo_companion/core/fila_cozmo.py:352`<br>`src/cozmo_companion/core/motor_cozmo.py:1369`<br>`src/cozmo_companion/core/motor_cozmo.py:2204` |
| `COZMO_BASE_OLED_CHARGER_FULL` | `'0'` | `src/cozmo_companion/core/conexao.py:995`<br>`src/cozmo_companion/core/motor_cozmo.py:1353` |
| `COZMO_BASE_OLED_HOLD_MAX_S` | `'12'`, `'15'` | `src/cozmo_companion/core/fila_cozmo.py:118`<br>`src/cozmo_companion/core/motor_cozmo.py:441`<br>`src/cozmo_companion/notifications/core/handler.py:169` |
| `COZMO_BASE_OLED_HOLD_STACK` | `'2.5'` | `src/cozmo_companion/core/motor_cozmo.py:446` |
| `COZMO_BASE_OLED_KEEPALIVE` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:2603`<br>`src/cozmo_companion/core/motor_cozmo.py:1488` |
| `COZMO_BASE_OLED_KEEPALIVE_HZ` | `'5'` | `src/cozmo_companion/core/motor_cozmo.py:2513` |
| `COZMO_BASE_OLED_LOOP_BACKOFF_S` | `'240'` | `src/cozmo_companion/core/motor_cozmo.py:1535` |
| `COZMO_BASE_OLED_MANTER_EM_STALL` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:2532` |
| `COZMO_BASE_OLED_MIN` | `'1'` | `src/cozmo_companion/core/conexao.py:997`<br>`src/cozmo_companion/core/motor_cozmo.py:3970`<br>`src/cozmo_companion/core/motor_cozmo.py:3897` |
| `COZMO_BASE_OLED_MIN_BYTES` | `'56'` | `src/cozmo_companion/core/motor_cozmo.py:2308` |
| `COZMO_BASE_OLED_MIN_FRAMES` | `'8'` | `src/cozmo_companion/core/anim_base_patch.py:155`<br>`src/cozmo_companion/core/motor_cozmo.py:1140`<br>`src/cozmo_companion/core/motor_cozmo.py:2307`<br>`src/cozmo_companion/core/motor_cozmo.py:2408` |
| `COZMO_BASE_OLED_MODE` | `'proc'` | `src/cozmo_companion/core/motor_cozmo.py:1490`<br>`src/cozmo_companion/core/motor_cozmo.py:3940` |
| `COZMO_BASE_OLED_STALL_HZ` | `'0.25'` | `src/cozmo_companion/core/motor_cozmo.py:1547`<br>`src/cozmo_companion/core/motor_cozmo.py:2546` |
| `COZMO_BASE_OLED_TX_RX_STALL_GRACE_S` | `'180'` | `src/cozmo_companion/core/motor_cozmo.py:849` |
| `COZMO_BASE_POOL_SEGURO` | `'1'` | `src/cozmo_companion/core/anims.py:595` |
| `COZMO_BASE_PROC_HZ` | `'2'`, `'3'` | `src/cozmo_companion/core/motor_cozmo.py:3483`<br>`src/cozmo_companion/core/motor_cozmo.py:3804` |
| `COZMO_BASE_PULSE_PROC` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:3991` |
...
| `COZMO_BASE_STABLE_OLED` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:3950` |
| `COZMO_BASE_STABLE_TEXT` | `'0'` | `src/cozmo_companion/core/fila_cozmo.py:568` |
| `COZMO_BASE_STALL_PULSO_S` | `'1.5'` | `src/cozmo_companion/core/cozmo01_recovery.py:154` |
| `COZMO_BASE_STOP_RODAS_CMD` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:902` |
| `COZMO_BASE_TX_BACKPRESSURE_S` | `'1.5'` | `src/cozmo_companion/core/motor_cozmo.py:837` |
| `COZMO_BASE_TX_STALL` | `'280'` | `src/cozmo_companion/core/config.py:25` |
| `COZMO_BASE_VARIAR_ANTI_REPEAT` | `'3'` | `src/cozmo_companion/core/motor_cozmo.py:1104`<br>`src/cozmo_companion/core/motor_cozmo.py:1274`<br>`src/cozmo_companion/core/motor_cozmo.py:1598` |
| `COZMO_BASE_VARIAR_CHANCE` | `'0.38'` | `src/cozmo_companion/core/motor_cozmo.py:1244` |
| `COZMO_BASE_VARIAR_EXTRA_MAX` | `'14'` | `src/cozmo_companion/core/anims.py:565` |
| `COZMO_BASE_VARIAR_FORCADO_MIN_S` | `'8'` | `src/cozmo_companion/core/motor_cozmo.py:1240` |
| `COZMO_BASE_VARIAR_JITTER_S` | `'8'` | `src/cozmo_companion/core/motor_cozmo.py:1678` |
| `COZMO_BASE_VARIAR_LUZ` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:1196` |
| `COZMO_BASE_VARIAR_MAX_S` | `'55'` | `src/cozmo_companion/core/motor_cozmo.py:1679` |
| `COZMO_BASE_VARIAR_S` | `'32'`, `'38'` | `src/cozmo_companion/core/motor_cozmo.py:1677`<br>`src/cozmo_companion/core/motor_cozmo.py:1235` |
| `COZMO_BASE_WAKE_ANIM` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:4310` |
| `COZMO_BOOT_ACORDADO` | `'1'` | `src/cozmo_companion/core/companion.py:1921`<br>`src/cozmo_companion/core/companion.py:1966` |
| `COZMO_BOOT_FRESH_SESSION` | `'0'` | `src/cozmo_companion/core/companion.py:1349`<br>`src/cozmo_companion/core/companion.py:1358`<br>`src/cozmo_companion/core/companion.py:1962`<br>`src/cozmo_companion/core/companion.py:1322`<br>`src/cozmo_companion/core/companion.py:1341` |
| `COZMO_BOOT_FRESH_WAIT_S` | `'6'` | `src/cozmo_companion/core/companion.py:1321` |
| `COZMO_BOOT_OLED_SETTLE_S` | `'0.35'` | `src/cozmo_companion/core/companion.py:1973`<br>`src/cozmo_companion/core/motor_cozmo.py:4515`<br>`src/cozmo_companion/core/motor_cozmo.py:4541` |
| `COZMO_BOOT_QUIET_S` | `'4'` | `src/cozmo_companion/core/companion.py:2027` |
| `COZMO_BOOT_RX_FRESH_MAX` | `'220'` | `src/cozmo_companion/core/conexao.py:851` |
| `COZMO_BOOT_RX_MIN` | `'20'` | `src/cozmo_companion/core/conexao.py:859` |
| `COZMO_BUFFER_CHEIO_HOLD_S` | `'3'` | `src/cozmo_companion/core/companion.py:727` |
| `COZMO_CHARGER_AWAKE_IDLE` | `'IdleOnCharger'`, `None` | `src/cozmo_companion/core/motor_cozmo.py:1061`<br>`src/cozmo_companion/core/motor_cozmo.py:3161`<br>`src/cozmo_companion/core/motor_cozmo.py:1218`<br>`src/cozmo_companion/core/motor_cozmo.py:1197`<br>`src/cozmo_companion/core/motor_cozmo.py:1596`<br>`src/cozmo_companion/core/motor_cozmo.py:2696`<br>`src/cozmo_companion/core/motor_cozmo.py:3381`<br>`src/cozmo_companion/core/motor_cozmo.py:4687`<br>`src/cozmo_companion/core/motor_cozmo.py:4506` |
| `COZMO_CHARGER_CLIP_S` | `'14'` | `src/cozmo_companion/core/motor_cozmo.py:1454` |
| `COZMO_CHARGER_LOOP_PAUSE_S` | `'0.12'` | `src/cozmo_companion/core/motor_cozmo.py:1971` |
| `COZMO_CHARGER_OLED_HZ` | `'1.5'`, `'2.5'`, `'4'` | `src/cozmo_companion/core/motor_cozmo.py:3001`<br>`src/cozmo_companion/core/motor_cozmo.py:1632`<br>`src/cozmo_companion/core/motor_cozmo.py:3463` |
| `COZMO_CHARGER_OLED_KEEPER` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:2144` |
| `COZMO_CHARGER_PLAY_STREAM` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:1487`<br>`src/cozmo_companion/core/motor_cozmo.py:2177`<br>`src/cozmo_companion/core/motor_cozmo.py:2193` |
| `COZMO_CHARGER_REPLAY_S` | `'18'` | `src/cozmo_companion/core/motor_cozmo.py:3003` |
| `COZMO_CHARGER_STREAM_NA_CHEIA` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:2179` |
| `COZMO_CHARGE_IDLE_S` | `'18'` | `src/cozmo_companion/core/charger.py:777`<br>`src/cozmo_companion/core/motor_cozmo.py:4940` |
| `COZMO_COMPANION_ROOT` | `''`, `'/mnt/G/PROJETOS/cozmo-companion'` | `src/cozmo_companion/core/conexao.py:18`<br>`src/cozmo_companion/core/paths.py:10`<br>`src/cozmo_companion/guardian/__main__.py:44` |
| `COZMO_CONNECT_PAUSE_S` | `'5'` | `src/cozmo_companion/core/conexao.py:988` |
| `COZMO_CONNECT_TIMEOUT` | `'30'` | `src/cozmo_companion/core/conexao.py:986` |
| `COZMO_CONNECT_TRIES` | `'5'` | `src/cozmo_companion/core/conexao.py:987` |
| `COZMO_COZMO01_RESET_UDP` | `'1'` | `src/cozmo_companion/core/conexao.py:158` |
...
| `COZMO_DISCONNECT_PAUSE_MIN_S` | `'0.3'` | `src/cozmo_companion/core/conexao.py:1071` |
| `COZMO_DISCONNECT_PAUSE_S` | `'12'`, `'5'` | `src/cozmo_companion/core/companion.py:1229`<br>`src/cozmo_companion/core/companion.py:1226`<br>`src/cozmo_companion/core/conexao.py:1065` |
...
| `COZMO_ESCURO_ESPIAR_CHANCE` | `'0.38'` | `src/cozmo_companion/core/motor_cozmo.py:1334` |
| `COZMO_ESCURO_ESPIAR_INTERVALO_S` | `'360'` | `src/cozmo_companion/core/motor_cozmo.py:1331` |
| `COZMO_ESCURO_ESPIAR_S` | `'14'` | `src/cozmo_companion/core/motor_cozmo.py:1341` |
...
| `COZMO_ESCURO_VARIAR_S` | `'75'` | `src/cozmo_companion/core/motor_cozmo.py:1233` |
| `COZMO_FACE_BASE` | `'0'` | `src/cozmo_companion/core/companion.py:1736`<br>`src/cozmo_companion/core/face_watch.py:83`<br>`src/cozmo_companion/core/face_watch.py:133`<br>`src/cozmo_companion/core/face_watch.py:140`<br>`src/cozmo_companion/core/face_watch.py:216`<br>`src/cozmo_companion/core/vida.py:173`<br>`src/cozmo_companion/core/vida.py:759` |
| `COZMO_FACE_BASE_FORCE` | `'0'` | `src/cozmo_companion/core/face_watch.py:134`<br>`src/cozmo_companion/core/face_watch.py:187` |
| `COZMO_FACE_KEEP_S` | `'8'` | `src/cozmo_companion/core/companion.py:987` |
...
| `COZMO_FULL_CHARGE_WAKE` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:3846` |
| `COZMO_FULL_CHARGE_WAKE_S` | `'12'` | `src/cozmo_companion/core/motor_cozmo.py:3852` |
| `COZMO_HEALTH_FILE` | `''` | `src/cozmo_companion/core/paths.py:28` |
| `COZMO_INPLACE_FAIL_MAX` | `'2'` | `src/cozmo_companion/core/companion.py:1109` |
| `COZMO_INPLACE_PAUSE_S` | `'1.5'` | `src/cozmo_companion/core/conexao.py:896` |
| `COZMO_IP` | `'172.31.1.1'` | `src/cozmo_companion/core/conexao.py:19`<br>`src/cozmo_companion/core/radio_keepalive.py:62` |
| `COZMO_KEEPALIVE_S` | `'10'` | `src/cozmo_companion/core/companion.py:1389` |
| `COZMO_KEEPER_DURING_TTS` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:3514` |
...
| `COZMO_LIVRE_PROC_FACE` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:4217`<br>`src/cozmo_companion/core/motor_cozmo.py:4627` |
...
| `COZMO_NEVER_DISCONNECT` | `'1'` | `src/cozmo_companion/core/companion.py:2170`<br>`src/cozmo_companion/core/conexao.py:129`<br>`src/cozmo_companion/core/conexao.py:576` |
| `COZMO_NICE` | `'10'` | `src/cozmo_companion/core/companion.py:2160` |
...
| `COZMO_OLED_BURST_GAP_S` | `'0.033'` | `src/cozmo_companion/core/motor_cozmo.py:4796` |
| `COZMO_OLED_DIRECT` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:4761` |
...
| `COZMO_OLED_KEEPALIVE_S` | `'0.45'` | `src/cozmo_companion/core/motor_cozmo.py:4167` |
| `COZMO_OLED_KEEPER_MAX_HZ` | `'0.5'` | `src/cozmo_companion/core/motor_cozmo.py:138`<br>`src/cozmo_companion/core/motor_cozmo.py:4681` |
| `COZMO_OLED_MAX_ESTATICO_S` | `'18'` | `src/cozmo_companion/core/motor_cozmo.py:583` |
| `COZMO_OLED_NA_BASE` | `'0'` | `src/cozmo_companion/core/companion.py:452`<br>`src/cozmo_companion/core/fila_cozmo.py:351`<br>`src/cozmo_companion/core/motor_cozmo.py:4741` |
| `COZMO_OLED_PHASE_UPGRADE_S` | `'45'` | `src/cozmo_companion/core/motor_cozmo.py:111` |
| `COZMO_OLED_REFRESH_S` | `'12'`, `'2.5'` | `src/cozmo_companion/core/motor_cozmo.py:4159`<br>`src/cozmo_companion/display/face.py:143` |
| `COZMO_OLED_RESCUE_MIN_BYTES` | `'64'` | `src/cozmo_companion/core/motor_cozmo.py:2215` |
| `COZMO_OLED_RESCUE_RECENT_S` | `'15'` | `src/cozmo_companion/core/motor_cozmo.py:815` |
| `COZMO_OLED_RESCUE_STALL_GRACE_S` | `'8'` | `src/cozmo_companion/core/motor_cozmo.py:819`<br>`src/cozmo_companion/core/motor_cozmo.py:2540` |
| `COZMO_OLED_VERDE_KEEPER_HZ` | `'0'`, `'0.5'` | `src/cozmo_companion/core/motor_cozmo.py:124`<br>`src/cozmo_companion/core/motor_cozmo.py:4682` |
| `COZMO_OLED_WATCHDOG_S` | `'4'` | `src/cozmo_companion/core/motor_cozmo.py:677` |
| `COZMO_ORIGINAL_APP_ENGINE` | `'1'` | `src/cozmo_companion/core/anims.py:597` |
| `COZMO_PING_INTERVAL_S` | `'0.5'` | `src/cozmo_companion/core/motor_cozmo.py:4038` |
| `COZMO_PING_PRE_CLIP` | `'2'` | `src/cozmo_companion/core/motor_cozmo.py:2369` |
| `COZMO_PING_TIMEOUT_S` | `'4'` | `src/cozmo_companion/core/conexao.py:138` |
| `COZMO_POST_RECONNECT_S` | `'22'`, `'60'` | `src/cozmo_companion/core/companion.py:271`<br>`src/cozmo_companion/core/companion.py:399`<br>`src/cozmo_companion/core/companion.py:411`<br>`src/cozmo_companion/core/companion.py:1209`<br>`src/cozmo_companion/core/limites.py:34` |
| `COZMO_POS_TTS_BASE_S` | `'18'` | `src/cozmo_companion/core/companion_voz.py:137` |
| `COZMO_PPCLIP_RX_STALL_S` | `'120'` | `src/cozmo_companion/core/conexao.py:687` |
| `COZMO_PROC_CHARGE_IDLE` | `'0'` | `src/cozmo_companion/core/charger.py:789` |
| `COZMO_PROC_FACE` | `'1'` | `src/cozmo_companion/core/companion.py:317`<br>`src/cozmo_companion/core/conexao.py:1002`<br>`src/cozmo_companion/core/motor_cozmo.py:4267`<br>`src/cozmo_companion/core/motor_cozmo.py:4626`<br>`src/cozmo_companion/core/motor_cozmo.py:4733`<br>`src/cozmo_companion/display/face.py:129` |
| `COZMO_PROC_FACE_BASE` | `'0'`, `'1'` | `src/cozmo_companion/core/charger.py:796`<br>`src/cozmo_companion/core/companion.py:316`<br>`src/cozmo_companion/core/conexao.py:902`<br>`src/cozmo_companion/core/face_watch.py:421`<br>`src/cozmo_companion/core/motor_cozmo.py:2156`<br>`src/cozmo_companion/core/motor_cozmo.py:4226`<br>`src/cozmo_companion/core/motor_cozmo.py:4104`<br>`src/cozmo_companion/core/motor_cozmo.py:4265`<br>`src/cozmo_companion/core/vida.py:229`<br>`src/cozmo_companion/core/vida.py:560` |
| `COZMO_PROC_RX_STALL_S` | `'120'` | `src/cozmo_companion/core/config.py:27` |
| `COZMO_PROC_STALL_RATIO_MAX` | `'8.0'` | `src/cozmo_companion/core/conexao.py:688` |
| `COZMO_RADIO_KEEPALIVE` | `'0'` | `src/cozmo_companion/core/radio_keepalive.py:37` |
| `COZMO_RADIO_KEEPALIVE_HZ` | `'50'` | `src/cozmo_companion/core/radio_keepalive.py:64` |
| `COZMO_RADIO_KEEPALIVE_PORT` | `'55001'` | `src/cozmo_companion/core/radio_keepalive.py:63` |
| `COZMO_RATIO_PREVENT_COOLDOWN_S` | `'25'` | `src/cozmo_companion/core/companion.py:1188`<br>`src/cozmo_companion/core/sessao_guard.py:20` |
| `COZMO_READY_S` | `'18'` | `src/cozmo_companion/core/conexao.py:920` |
...
| `COZMO_RECONNECT_MAX_S` | `'45'` | `src/cozmo_companion/core/conexao.py:1104` |
| `COZMO_RECONNECT_S` | `'12'` | `src/cozmo_companion/core/conexao.py:1103` |
| `COZMO_RECONNECT_WAIT_PING_S` | `'25'` | `src/cozmo_companion/core/companion.py:1212` |
| `COZMO_RENOVAR_BASE_S` | `'20'` | `src/cozmo_companion/core/motor_cozmo.py:2804`<br>`src/cozmo_companion/core/motor_cozmo.py:3057` |
| `COZMO_RENOVAR_FORCAR_MIN_S` | `'8'` | `src/cozmo_companion/core/motor_cozmo.py:2807` |
| `COZMO_RESOURCE_DIR` | `''` | `src/cozmo_companion/core/original_app.py:91` |
| `COZMO_RX_DEAD_RATIO` | `'8.0'` | `src/cozmo_companion/core/conexao.py:875` |
| `COZMO_RX_HARD_DEAD_S` | `'20'` | `src/cozmo_companion/core/conexao.py:703` |
| `COZMO_RX_STALL_PARADO_S` | `'18'` | `src/cozmo_companion/core/config.py:28` |
| `COZMO_RX_STALL_RATIO_S` | `'12'` | `src/cozmo_companion/core/conexao.py:682` |
| `COZMO_RX_STALL_S` | `'12'`, `'30'` | `src/cozmo_companion/core/conexao.py:663`<br>`src/cozmo_companion/core/limites.py:33` |
| `COZMO_RX_STALL_TX_MIN` | `'200'` | `src/cozmo_companion/core/conexao.py:691` |
| `COZMO_SEMPRE_NA_BASE` | `'0'` | `src/cozmo_companion/core/companion.py:296` |
| `COZMO_SENSOR_REACTION_COOLDOWN_S` | `'2.5'` | `src/cozmo_companion/core/companion.py:245` |
| `COZMO_SESSAO_RX_MIN` | `'12'` | `src/cozmo_companion/core/conexao.py:350` |
| `COZMO_SETTLE_S` | `'1.0'` | `src/cozmo_companion/core/conexao.py:1026` |
...
| `COZMO_SLEEP_CLIP_HOLD_S` | `'22'`, `'28'` | `src/cozmo_companion/core/motor_cozmo.py:1674`<br>`src/cozmo_companion/core/motor_cozmo.py:1791` |
| `COZMO_SLEEP_CLIP_JITTER_S` | `'10'` | `src/cozmo_companion/core/motor_cozmo.py:1675` |
...
| `COZMO_SONO_FLASH_ZZZ` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:247` |
| `COZMO_SONO_NA_BASE` | `'0'` | `src/cozmo_companion/core/ambiente_escuro.py:166`<br>`src/cozmo_companion/core/companion.py:214`<br>`src/cozmo_companion/core/vida.py:674` |
| `COZMO_SONO_OLED_TEXTO` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:211` |
| `COZMO_STABLE_OLED_RESCUE_HZ` | `'6'` | `src/cozmo_companion/core/motor_cozmo.py:2702` |
| `COZMO_STABLE_OLED_RESCUE_S` | `'2.8'` | `src/cozmo_companion/core/motor_cozmo.py:2701` |
| `COZMO_STABLE_RADIO_KEEPALIVE` | `'0'` | `src/cozmo_companion/core/radio_keepalive.py:30` |
...
| `COZMO_SYNC_BASE_RX_OFF_S` | `'3'` | `src/cozmo_companion/core/motor_cozmo.py:4285` |
| `COZMO_SYNC_BASE_S` | `'5'`, `'8'` | `src/cozmo_companion/core/motor_cozmo.py:2909`<br>`src/cozmo_companion/core/motor_cozmo.py:4283` |
...
| `COZMO_UDP_DELTA_RATIO_LEVE` | `'4.5'` | `src/cozmo_companion/core/conexao.py:479`<br>`src/cozmo_companion/core/governador.py:226` |
| `COZMO_UDP_DELTA_TX_LEVE` | `'450'` | `src/cozmo_companion/core/conexao.py:481` |
| `COZMO_UDP_DELTA_TX_SAT` | `'500'` | `src/cozmo_companion/core/config.py:26` |
| `COZMO_UDP_JANELA_S` | `'30'` | `src/cozmo_companion/core/conexao.py:451` |
| `COZMO_UDP_QUIET_S` | `'12'`, `'25'` | `src/cozmo_companion/core/companion.py:420`<br>`src/cozmo_companion/core/limites.py:35` |
...
| `COZMO_WIFI_COOLDOWN_S` | `'60'` | `src/cozmo_companion/core/conexao.py:234`<br>`src/cozmo_companion/core/conexao.py:221` |
| `COZMO_WIFI_IFACE` | `'wlan0'` | `src/cozmo_companion/core/conexao.py:49` |
| `COZMO_WIFI_OFFLINE_RETRY_S` | `'20'` | `src/cozmo_companion/core/conexao.py:254`<br>`src/cozmo_companion/core/config.py:24` |
| `COZMO_WIFI_RESCAN_OFFLINE_S` | `'90'` | `src/cozmo_companion/core/conexao.py:227` |
| `COZMO_WIFI_RETRY_S` | `'25'` | `src/cozmo_companion/core/governador.py:95` |
| `COZMO_WIFI_ROUTE_RETRY_S` | `str(network_tuning().wifi_offline_retry_s)` | `src/cozmo_companion/core/conexao.py:211` |
| `COZMO_WIFI_SAFE` | `'1'` | `src/cozmo_companion/core/conexao.py:162` |
| `COZMO_WIFI_STALL_S` | `'25'` | `src/cozmo_companion/core/companion.py:1487` |
| `COZMO_WLAN0_PRESO_GRACA_S` | `'15'` | `src/cozmo_companion/core/conexao.py:107` |
...
| `GOV_PPCLIP_TX_IDLE_DELTA` | `'80'` | `src/cozmo_companion/core/conexao.py:690` |
...
| `GOV_RX_IDLE_RATIO_MAX` | `'0.95'` | `src/cozmo_companion/core/conexao.py:680`<br>`src/cozmo_companion/core/conexao.py:797` |
| `GOV_RX_RATIO_ALTO` | `'2.0'` | `src/cozmo_companion/core/conexao.py:838`<br>`src/cozmo_companion/core/conexao.py:681` |
| `GOV_TX_DELTA_STALL` | `'120'`, `'180'`, `'400'` | `src/cozmo_companion/core/conexao.py:664`<br>`src/cozmo_companion/core/conexao.py:354`<br>`src/cozmo_companion/core/governador.py:233`<br>`src/cozmo_companion/core/governador.py:300` |
| `GOV_TX_IDLE_DELTA` | `'50'` | `src/cozmo_companion/core/conexao.py:665` |
| `GOV_WIFI_PROBE_S` | `'90'` | `src/cozmo_companion/core/governador.py:94` |
| `GUARDIAN_BOOT_GRACE_S` | `'180'` | `src/cozmo_companion/guardian/core/policy.py:92` |
| `GUARDIAN_HEALTH_STALE_S` | `'240'` | `src/cozmo_companion/guardian/core/policy.py:91` |
| `GUARDIAN_INTERVAL_S` | `'20'` | `src/cozmo_companion/guardian/__main__.py:51` |
| `GUARDIAN_JSON_FRESH_PING_SKIP_S` | `'180'` | `src/cozmo_companion/guardian/core/health.py:261` |
| `GUARDIAN_LOG_TRIM_BOOT_GRACE_S` | `'600'` | `src/cozmo_companion/guardian/core/manutencao.py:20` |
| `GUARDIAN_LOG_TRIM_S` | `'86400'` | `src/cozmo_companion/guardian/core/manutencao.py:18` |
| `GUARDIAN_RESTART_DEAD_S` | `'120'` | `src/cozmo_companion/guardian/core/policy.py:83` |
| `GUARDIAN_SESSAO_FRESH_S` | `'300'` | `src/cozmo_companion/guardian/core/policy.py:106` |
| `GUARDIAN_WIFI_COOLDOWN_S` | `'25'` | `src/cozmo_companion/guardian/core/policy.py:120` |
...
| `LOOP_SLEEP` | `'0.15'`, `'0.25'` | `src/cozmo_companion/core/companion.py:2036`<br>`src/cozmo_companion/core/perf.py:46` |
...
| `PERCEPTION_ANIM_COOLDOWN_S` | `'18'` | `src/cozmo_companion/core/companion.py:358` |
| `PET_LIVRE_CAMERA_START_S` | `'10'` | `src/cozmo_companion/core/companion.py:668` |
| `PET_LIVRE_MAX_S` | `'11'` | `src/cozmo_companion/core/pet_livre.py:70` |
| `PET_LIVRE_MIN_S` | `'4'` | `src/cozmo_companion/core/pet_livre.py:69` |
| `PET_LIVRE_START_S` | `'1.2'` | `src/cozmo_companion/core/companion.py:671`<br>`src/cozmo_companion/core/pet_livre.py:52` |
...
| `PULSE_ANIM_CHANCE` | `'0.35'` | `src/cozmo_companion/core/companion.py:1706` |
| `REACAO_OFICIAL_ENABLED` | `'1'` | `src/cozmo_companion/core/companion_voz.py:577` |
| `SEMPRE_PULSE_S` | `'15'` | `src/cozmo_companion/core/companion.py:1689` |
...
| `SONO_OLED_REFRESH_S` | `'0.8'`, `'1.0'`, `'18'` | `src/cozmo_companion/core/motor_cozmo.py:431`<br>`src/cozmo_companion/core/motor_cozmo.py:336`<br>`src/cozmo_companion/display/face.py:145` |
| `SONO_PPCLIP_LOOP_MIN_S` | `'45'` | `src/cozmo_companion/core/motor_cozmo.py:343` |
| `SONO_PPCLIP_SEMEAR_S` | `os.environ.get('SONO_OLED_REFRESH_S', '18')` | `src/cozmo_companion/core/motor_cozmo.py:336` |
