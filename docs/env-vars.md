...
| `BARULHO_INTENSO_RMS` | `'2600'` | `src/cozmo_companion/core/companion_voz.py:654` |
...
| `BASE_HEAD_FRAC` | `'0.62'` | `src/cozmo_companion/core/motor_cozmo.py:3804` |
| `BASE_HEAD_MOVE_S` | `'22'` | `src/cozmo_companion/core/alive.py:73` |
| `BASE_HEAD_RESET` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:3821` |
| `BASE_HEAD_SPEED` | `'6.0'`, `'8.0'` | `src/cozmo_companion/core/alive.py:84`<br>`src/cozmo_companion/core/motor_cozmo.py:3828` |
| `BASE_HEAD_TOL_RAD` | `'0.09'` | `src/cozmo_companion/core/motor_cozmo.py:3811` |
...
| `BASE_TOGGLE_DEBOUNCE_S` | `'3'`, `'3.0'` | `src/cozmo_companion/core/charger.py:495`<br>`src/cozmo_companion/core/companion.py:661`<br>`src/cozmo_companion/core/companion_legacy.py:1966` |
...
| `BASE_VOICE_REACTIONS_ONLY` | `'1'` | `src/cozmo_companion/core/companion_voz.py:693` |
| `BASE_VOICE_REACTION_COOLDOWN_S` | `'4'` | `src/cozmo_companion/core/companion_voz.py:697` |
...
| `BOTAO_FILA_DRAIN_S` | `'10'` | `src/cozmo_companion/core/companion.py:645`<br>`src/cozmo_companion/core/companion_legacy.py:1924` |
| `BOTAO_OLED_S` | `'2.5'` | `src/cozmo_companion/core/companion.py:599`<br>`src/cozmo_companion/core/companion_legacy.py:1890` |
| `BOTAO_QUIET_S` | `'4'`, `'5'` | `src/cozmo_companion/core/companion.py:600`<br>`src/cozmo_companion/core/companion_legacy.py:1889`<br>`src/cozmo_companion/core/companion_legacy.py:1886` |
| `BOTAO_TRANSICAO_S` | `'8'`, `os.environ.get('BOTAO_QUIET_S', '5')` | `src/cozmo_companion/core/companion.py:606`<br>`src/cozmo_companion/core/companion_legacy.py:1884` |
...
| `COZMO01_AUTO_COOLDOWN_S` | `'18'` | `src/cozmo_companion/core/motor_cozmo.py:4272` |
| `COZMO01_CLIP_ACK_S` | `'0.45'` | `src/cozmo_companion/core/motor_cozmo.py:4232` |
| `COZMO01_DISCONNECT_PAUSE_S` | `os.environ.get('COZMO_DISCONNECT_PAUSE_S', '5')` | `src/cozmo_companion/core/companion.py:1145` |
| `COZMO01_DRAIN_S` | `'4'` | `src/cozmo_companion/core/motor_cozmo.py:4143` |
...
| `COZMO01_PING_GAP_S` | `'0.12'` | `src/cozmo_companion/core/motor_cozmo.py:4179` |
...
| `COZMO01_RX_DEAD_ROUTE_S` | `'20'`, `'90'` | `src/cozmo_companion/core/companion.py:1307`<br>`src/cozmo_companion/core/cozmo01_recovery.py:163`<br>`src/cozmo_companion/core/motor_cozmo.py:4171` |
| `COZMO01_RX_DEAD_S` | `'8'` | `src/cozmo_companion/core/conexao.py:657`<br>`src/cozmo_companion/core/motor_cozmo.py:4169` |
| `COZMO01_SLEEP_TIMEOUT_S` | `'120'` | `src/cozmo_companion/core/motor_cozmo.py:4173` |
...
| `COZMO_BASE_CLIP_REPLAY_MIN_S` | `'14'` | `src/cozmo_companion/core/motor_cozmo.py:2375` |
| `COZMO_BASE_DESPERTAR_S` | `'35'` | `src/cozmo_companion/core/companion.py:1416` |
| `COZMO_BASE_FACE_HZ` | `'0.25'` | `src/cozmo_companion/core/motor_cozmo.py:3956` |
| `COZMO_BASE_FULL_KEEPER_HZ` | `'4'`, `'7'` | `src/cozmo_companion/core/motor_cozmo.py:1597`<br>`src/cozmo_companion/core/motor_cozmo.py:3270` |
...
| `COZMO_BASE_KEEPER_VIVO` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:3154`<br>`src/cozmo_companion/core/motor_cozmo.py:4757`<br>`src/cozmo_companion/core/motor_cozmo.py:1281`<br>`src/cozmo_companion/core/motor_cozmo.py:3240`<br>`src/cozmo_companion/core/motor_cozmo.py:3915`<br>`src/cozmo_companion/core/motor_cozmo.py:4528`<br>`src/cozmo_companion/core/motor_cozmo.py:3639` |
...
| `COZMO_BASE_OLED_KEEPALIVE` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:2560`<br>`src/cozmo_companion/core/motor_cozmo.py:1463` |
| `COZMO_BASE_OLED_KEEPALIVE_HZ` | `'5'` | `src/cozmo_companion/core/motor_cozmo.py:2472` |
| `COZMO_BASE_OLED_LOOP_BACKOFF_S` | `'240'` | `src/cozmo_companion/core/motor_cozmo.py:1510` |
| `COZMO_BASE_OLED_MANTER_EM_STALL` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:2491` |
| `COZMO_BASE_OLED_MIN` | `'1'` | `src/cozmo_companion/core/conexao.py:947`<br>`src/cozmo_companion/core/motor_cozmo.py:3770`<br>`src/cozmo_companion/core/motor_cozmo.py:3712` |
| `COZMO_BASE_OLED_MIN_FRAMES` | `'8'` | `src/cozmo_companion/core/anim_base_patch.py:155`<br>`src/cozmo_companion/core/motor_cozmo.py:1129`<br>`src/cozmo_companion/core/motor_cozmo.py:2270`<br>`src/cozmo_companion/core/motor_cozmo.py:2367` |
| `COZMO_BASE_OLED_MODE` | `'proc'` | `src/cozmo_companion/core/motor_cozmo.py:1465`<br>`src/cozmo_companion/core/motor_cozmo.py:3755` |
| `COZMO_BASE_OLED_STALL_HZ` | `'0.25'` | `src/cozmo_companion/core/motor_cozmo.py:2505` |
...
| `COZMO_BASE_PROC_HZ` | `'2'`, `'3'` | `src/cozmo_companion/core/motor_cozmo.py:3356`<br>`src/cozmo_companion/core/motor_cozmo.py:3619` |
| `COZMO_BASE_PULSE_PROC` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:3791` |
...
| `COZMO_BASE_WAKE_ANIM` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:4103` |
...
| `COZMO_BOOT_QUIET_S` | `'4'`, `os.environ.get('COZMO_POST_RECONNECT_S', '10')` | `src/cozmo_companion/core/companion.py:1865`<br>`src/cozmo_companion/core/companion_legacy.py:3162` |
...
| `COZMO_CHARGER_AWAKE_IDLE` | `'IdleOnCharger'`, `None` | `src/cozmo_companion/core/motor_cozmo.py:1050`<br>`src/cozmo_companion/core/motor_cozmo.py:3044`<br>`src/cozmo_companion/core/motor_cozmo.py:1207`<br>`src/cozmo_companion/core/motor_cozmo.py:1186`<br>`src/cozmo_companion/core/motor_cozmo.py:1563`<br>`src/cozmo_companion/core/motor_cozmo.py:3254`<br>`src/cozmo_companion/core/motor_cozmo.py:4299` |
...
| `COZMO_CHARGER_OLED_HZ` | `'1.5'`, `'2.5'`, `'4'` | `src/cozmo_companion/core/motor_cozmo.py:2892`<br>`src/cozmo_companion/core/motor_cozmo.py:1599`<br>`src/cozmo_companion/core/motor_cozmo.py:3336` |
...
| `COZMO_CHARGER_REPLAY_S` | `'18'` | `src/cozmo_companion/core/motor_cozmo.py:2894` |
| `COZMO_CHARGER_STREAM_NA_CHEIA` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:2144` |
| `COZMO_CHARGE_IDLE_S` | `'18'` | `src/cozmo_companion/core/charger.py:777`<br>`src/cozmo_companion/core/motor_cozmo.py:4645` |
...
| `COZMO_DISCONNECT_PAUSE_S` | `'12'`, `'5'` | `src/cozmo_companion/core/companion.py:1150`<br>`src/cozmo_companion/core/companion.py:1147`<br>`src/cozmo_companion/core/companion_legacy.py:2634`<br>`src/cozmo_companion/core/conexao.py:1015` |
...
| `COZMO_FULL_CHARGE_WAKE` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:3661` |
| `COZMO_FULL_CHARGE_WAKE_S` | `'12'` | `src/cozmo_companion/core/motor_cozmo.py:3667` |
...
| `COZMO_KEEPER_DURING_TTS` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:3387` |
...
| `COZMO_NEVER_DISCONNECT` | `'1'` | `src/cozmo_companion/core/companion.py:1997`<br>`src/cozmo_companion/core/companion_legacy.py:3272`<br>`src/cozmo_companion/core/conexao.py:128`<br>`src/cozmo_companion/core/conexao.py:540` |
| `COZMO_NICE` | `'10'` | `src/cozmo_companion/core/companion.py:1991`<br>`src/cozmo_companion/core/companion_legacy.py:3268` |
...
| `COZMO_OFFLINE_BACKOFF_MAX_S` | `'600'` | `src/cozmo_companion/core/companion.py:2001` |
...
| `COZMO_OLED_DIRECT` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:4522` |
...
| `COZMO_OLED_REFRESH_S` | `'12'`, `'2.5'` | `src/cozmo_companion/core/motor_cozmo.py:3959`<br>`src/cozmo_companion/display/face.py:143` |
...
| `COZMO_OLED_RESCUE_STALL_GRACE_S` | `'8'` | `src/cozmo_companion/core/motor_cozmo.py:820`<br>`src/cozmo_companion/core/motor_cozmo.py:2499` |
...
| `COZMO_PING_INTERVAL_S` | `'0.5'` | `src/cozmo_companion/core/motor_cozmo.py:3838` |
| `COZMO_PING_OOB_S` | `'4.5'` | `src/cozmo_companion/core/companion_legacy.py:3100` |
| `COZMO_PING_PRE_CLIP` | `'2'` | `src/cozmo_companion/core/motor_cozmo.py:2328` |
...
| `COZMO_PROC_FACE` | `'1'` | `src/cozmo_companion/core/companion.py:304`<br>`src/cozmo_companion/core/companion_legacy.py:3090`<br>`src/cozmo_companion/core/companion_legacy.py:1869`<br>`src/cozmo_companion/core/companion_legacy.py:1931`<br>`src/cozmo_companion/core/conexao.py:952`<br>`src/cozmo_companion/core/motor_cozmo.py:4060`<br>`src/cozmo_companion/core/motor_cozmo.py:4412`<br>`src/cozmo_companion/core/motor_cozmo.py:4505`<br>`src/cozmo_companion/display/face.py:129` |
| `COZMO_PROC_FACE_BASE` | `'0'`, `'1'` | `src/cozmo_companion/core/charger.py:796`<br>`src/cozmo_companion/core/companion.py:303`<br>`src/cozmo_companion/core/companion_legacy.py:2937`<br>`src/cozmo_companion/core/conexao.py:852`<br>`src/cozmo_companion/core/face_watch.py:421`<br>`src/cozmo_companion/core/motor_cozmo.py:2123`<br>`src/cozmo_companion/core/motor_cozmo.py:4019`<br>`src/cozmo_companion/core/motor_cozmo.py:3904`<br>`src/cozmo_companion/core/motor_cozmo.py:4058`<br>`src/cozmo_companion/core/vida.py:229`<br>`src/cozmo_companion/core/vida.py:560` |
...
| `COZMO_RATIO_PREVENT_COOLDOWN_S` | `'25'`, `'45'` | `src/cozmo_companion/core/companion.py:1122`<br>`src/cozmo_companion/core/companion_legacy.py:2795`<br>`src/cozmo_companion/core/sessao_guard.py:20` |
...
| `COZMO_RENOVAR_BASE_S` | `'20'` | `src/cozmo_companion/core/motor_cozmo.py:2695`<br>`src/cozmo_companion/core/motor_cozmo.py:2940` |
| `COZMO_RENOVAR_FORCAR_MIN_S` | `'8'` | `src/cozmo_companion/core/motor_cozmo.py:2698` |
...
| `COZMO_SYNC_BASE_RX_OFF_S` | `'3'` | `src/cozmo_companion/core/motor_cozmo.py:4078` |
| `COZMO_SYNC_BASE_S` | `'5'`, `'8'` | `src/cozmo_companion/core/motor_cozmo.py:2800`<br>`src/cozmo_companion/core/motor_cozmo.py:4076` |
...
| `COZMO_VOZ_INJECT` | `'0'` | `src/cozmo_companion/core/companion_legacy.py:2522`<br>`src/cozmo_companion/core/companion_voz.py:940` |
...
| `COZMO_WIFI_STALL_S` | `'25'` | `src/cozmo_companion/core/companion.py:1360` |
...
| `LATIDO_COOLDOWN_S` | `'4'` | `src/cozmo_companion/core/companion_voz.py:661` |
| `LLM_ACOES` | `'1'` | `src/cozmo_companion/core/companion_legacy.py:2117`<br>`src/cozmo_companion/core/companion_legacy.py:1657`<br>`src/cozmo_companion/core/companion_legacy.py:2074`<br>`src/cozmo_companion/core/companion_voz.py:891`<br>`src/cozmo_companion/voice/chat.py:63` |
| `LOOP_SLEEP` | `'0.15'`, `'0.25'` | `src/cozmo_companion/core/companion.py:1874`<br>`src/cozmo_companion/core/perf.py:46` |
...
| `NOTIF_ENABLED` | `'0'` | `src/cozmo_companion/core/companion_legacy.py:2579`<br>`src/cozmo_companion/core/companion_voz.py:982`<br>`src/cozmo_companion/notifications/core/policy.py:171` |
...
| `PET_LIVRE_CAMERA_START_S` | `'10'` | `src/cozmo_companion/core/companion.py:639` |
| `PET_LIVRE_MAX_S` | `'11'` | `src/cozmo_companion/core/pet_livre.py:70` |
| `PET_LIVRE_MIN_S` | `'4'` | `src/cozmo_companion/core/pet_livre.py:69` |
| `PET_LIVRE_START_S` | `'1.2'` | `src/cozmo_companion/core/companion.py:642`<br>`src/cozmo_companion/core/pet_livre.py:52` |
...
| `PULSE_ANIM_CHANCE` | `'0.35'` | `src/cozmo_companion/core/companion.py:1563` |
| `REACAO_OFICIAL_ENABLED` | `'1'` | `src/cozmo_companion/core/companion_voz.py:574` |
| `SEMPRE_PULSE_S` | `'15'`, `'16'` | `src/cozmo_companion/core/companion.py:1546`<br>`src/cozmo_companion/core/companion_legacy.py:2249` |
...
| `VOSK_MODEL` | `'/mnt/G/PROJETOS/cozmo-companion/data/vosk-model-small-pt-0.3'` | `src/cozmo_companion/core/companion_legacy.py:2554`<br>`src/cozmo_companion/core/companion_voz.py:957` |
...
| `WAKE_RELAX` | `'1'` | `src/cozmo_companion/core/companion_legacy.py:1502`<br>`src/cozmo_companion/core/companion_voz.py:746` |
