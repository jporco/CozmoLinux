...
| `COZMO_SONO_FLASH_ZZZ` | `'1'` | `src/cozmo_companion/core/motor_cozmo.py:243` |
...
| `COZMO_SONO_OLED_TEXTO` | `'0'` | `src/cozmo_companion/core/motor_cozmo.py:207` |
...
| `SONO_OLED_REFRESH_S` | `'0.8'`, `'1.0'`, `'18'` | `src/cozmo_companion/core/motor_cozmo.py:427`<br>`src/cozmo_companion/core/motor_cozmo.py:332`<br>`src/cozmo_companion/display/face.py:145` |
| `SONO_PPCLIP_LOOP_MIN_S` | `'45'` | `src/cozmo_companion/core/motor_cozmo.py:339` |
| `SONO_PPCLIP_SEMEAR_S` | `os.environ.get('SONO_OLED_REFRESH_S', '18')` | `src/cozmo_companion/core/motor_cozmo.py:332` |
